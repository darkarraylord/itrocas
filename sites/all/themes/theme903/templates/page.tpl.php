...
<?php if ( !theme_get_setting( 'theme903_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme903_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1">
				<div class="container-12">
					<div class="grid-12">
						<div class="col-1">
							<!-- Logo -->
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_bottom'] ) : ?>
				<div class="content-bottom-section-1">
					<div class="container-12">
						<div class="grid-12">
			...
			<?php if ( $page['content_bottom_second'] ) : ?>
				<div class="content-bottom-section-2">
					<div class="container-12">
						<div class="grid-12">
			...
			<?php if ( $page['content_bottom_third'] ) : ?>
				<div class="content-bottom-section-3">
					<div class="container-12">
						<div class="grid-12">
			...
			<div class="container-12">
				<div class="grid-12 clearfix">
					...
					<div class="footer-wrapper clearfix">
						...
						<?php if ( $is_front ) : ?>
							More Outsourcing Company Drupal Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/outsourcing-company-drupal-themes/" target="_blank">TemplateMonster.com</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
